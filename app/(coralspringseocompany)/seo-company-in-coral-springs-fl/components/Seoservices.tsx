      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services for Coral Springs Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            One method will not make your SEO campaign successful. Your website, local SEO, content, technical SEO and the authority of your domain all combine to improve the barriers for potential customers to find you. We combine all of these elements into a single strategy based upon your business and objectives.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          As a Coral Springs SEO Firm, this is what we‘re trying to do: synthesize these services into a logical plan of attack, not think about SEO as an amorphous set of individual to-do items.
        </Typography>
