      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            A Local SEO Strategy Built Around Your Business
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Each business has unique customers, market and competition, services or products offered and development objectives. That is why we don´t offer an individual SEO checklist for all our clients. Our first step is to learn what your customers are looking for.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          The outcome is an SEO strategy to enhance <span className="text-[#FFFFFF] font-semibold">relevant visibility, qualified traffic, and business growth</span> not rankings.
          </Typography>
      </div>
    </section>
  );
