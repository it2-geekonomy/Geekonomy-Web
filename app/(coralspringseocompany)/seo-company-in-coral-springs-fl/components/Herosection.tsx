                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Coral Springs SEO Company{" "}
                            <span className="text-[#69AE44]">That Helps You Get Found and Get More Customers</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          The people who will buy from you are already searching for what you sell. The hard part is ensuring they find you instead of, or before, a competitor. An effective SEO plan can enable you to generate visibility for the searches that matter, and convert that visibility into a reliable flow of quality leads.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          We, as an <span className="text-[#FFFFFF] font-semibold">SEO company in Coral Springs FL</span>, develop individualized search techniques according to your business type, services, customer‘s preferences and the local market. We focus on increasing your rankings on Google but also on how to generate calls, enquiries, quote requests, and new business coming in the door.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Coral-Springs.webp"
                                alt="Coral Springs FL"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Coral Springs SEARCHES INTO CUSTOMERS
                    </Typography>
