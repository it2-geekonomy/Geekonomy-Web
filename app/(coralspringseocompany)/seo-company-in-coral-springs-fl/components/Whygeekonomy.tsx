      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as Your Coral Springs SEO Company?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Selecting the right SEO partner is finding a team that comprehends what is driving the search visibility and how it connects with your website, customers and the business.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          Working as a Coral Springs SEO firm, we will develop a search plan that will be scalable to accommodate your growth and setting in stone a solid base for sustainable organic development.
        </Typography>
      </div>
    </section>
  );
