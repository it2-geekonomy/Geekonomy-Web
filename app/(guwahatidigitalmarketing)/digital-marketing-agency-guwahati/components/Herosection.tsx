                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Digital Marketing Agency in Guwahati{" "}
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Your customers are already looking for your products and services. The key is ensuring they find you, believe in your brand and act. As a digital marketing agency in Guwahati, Geekonomy, the best digital marketing agency, develops strategies to market your business to the right audience through Google Search, Google Maps, paid advertising, social media, and other digital channels
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Our focus is not just on the traffic or impressions. We bring together the search engine optimization, local searches, paid campaigns, content, and conversion strategies to help provide the leads, calls, bookings, and customers.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/guwahati-herosection.png"
                                alt="Digital Marketing Company in guwahati"
