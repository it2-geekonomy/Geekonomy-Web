                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#69AE44]/30 px-4 py-2 backdrop-blur-sm">
                            ...
                            <Typography variant="overline" className="text-white text-nowrap">
                              Fort Walton Beach SEO Agency
                            </Typography>
                        </div>

                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Fort Walton Beach SEO Company{" "}
                            <span className="text-[#69AE44]">That Drives Qualified Customers</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Your potential customers are already looking for what you sell online. The question is, are they finding you? As an SEO company Fort Walton Beach FL businesses can depend on, Geekonomy builds search campaigns that will help your business be seen, bring the right visitors to your website and produce enquiries.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          We provide a blend of local search engine optimization, technical enhancements, content development, keyword optimization and conversion optimization that enable your site to rank well for desirable search phrases. No matter if you market to consumers all over Fort Walton Beach or to the residents of nearby Emerald Coast, we‘ll help target those who are seeking out your products and services.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          When looking at different Fort Walton Beach SEO companies, don‘t be fooled by rankings, a good SEO campaign should bring increased visibility and aid in attaining tangible business results phone calls, form submissions, bookings, leads.
                        </Typography>
                        ...
                        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:flex-wrap sm:justify-center lg:justify-start">
                            <a href="#contact" onClick={handleScrollToContact} className="inline-flex w-72 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#69AE44] to-[#8FCB63] px-7 py-4 transition-transform hover:scale-[1.03] sm:w-auto">
                                <Typography variant="body-lg" className="font-semibold text-black">
                                  Get a free SEO strategy for your business
                                </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/fort-walton-beach.png"
                                alt="Fort Walton Beach"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Fort Walton Beach SEARCHES INTO CUSTOMERS
                    </Typography>
