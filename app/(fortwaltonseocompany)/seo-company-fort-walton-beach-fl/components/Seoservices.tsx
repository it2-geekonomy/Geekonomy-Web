      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services for Fort Walton Beach Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            A successful SEO campaign requires more than adding keywords to a website. Your technical foundation, content, local presence, authority, and user experience all influence how effectively your business can compete in search results. Geekonomy brings these elements together through a focused SEO strategy built around your goals and target customers.
          </Typography>
        </div>
