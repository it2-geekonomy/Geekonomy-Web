          ...
          <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-[#69AE44]/25 blur-[6.25rem]" />
            ...
            <div className="relative ">
                <Typography variant="display-2xl" as="p" className="text-white  leading-tight">
                  Ready to Grow Your Visibility in Fort Walton Beach?
                </Typography>

                <Typography variant="body-xl" className="mx-auto mt-5 max-w-4xl leading-relaxed text-white/90">
                  Your customers are already searching for the services you offer. A powerful SEO campaign will help you rank higher when they search and create a smoother journey from search to enquiry.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  Geekonomy will assess where you stand today, evaluate the opportunities in the Fort Walton Beach market, and create an SEO plan aligned with your business goals.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90 font-semibold">
                  Whether you need stronger local visibility, better organic rankings, more qualified traffic, or higher conversion rates from search visitors, we’ll help you focus on the SEO activities that can make the greatest impact.
                </Typography>
