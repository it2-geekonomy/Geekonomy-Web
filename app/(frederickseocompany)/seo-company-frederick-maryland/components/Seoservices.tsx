      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services for Frederick Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            This is just the beginning of what your SEO plan must involve. Geekonomy tends to encompass the basic index building blocks that will assist in boosting business exposure and bringing customers to your door step.
          </Typography>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-center w-full max-w-95 mx-auto md:max-w-none md:mx-0 rounded-[1.25rem] bg-gradient-to-br from-[#69AE44] to-[#4d8a2f] p-7 ">
            ...
            <Typography variant="body-lg" className="mb-2 text-black/70">
              We help Frederick, Maryland businesses improve search visibility, attract the right customers, and grow with a tailored SEO strategy.
            </Typography>
            <a
              href="#contact"
