      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            A Simple SEO Process Built Around Your Goals
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            A good SEO campaign begins with knowing your business, your customer base, and your competitors. Whatever the campaign, Geekonomy has a defined process that takes the information gathered through research and turns it into results you can see.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          By doing this our team is able to uniquely focus the SEO campaign on this particular website and is not trying to apply the same methods to all of the businesses that we work with.
        </Typography>
      </div>
    </section>
  );
