                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Frederick SEO Company{" "}
                            <span className="text-[#69AE44]">That Drives Business Growth</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Be discovered by more potential customers in Frederick who are searching for what you offer. Geekonomy provides expert search engine optimization designed to increase your search exposure and attract relevant site visitors that turn into enquiries and sales.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          As a well established <span className="text-[#FFFFFF] font-semibold">SEO</span> Company <span className="text-[#FFFFFF] font-semibold">Frederick Maryland</span> companies can depend on, we use a range of techniques including technical SEO, local optimization, content creation and authority campaigns to deliver sustainable organic growth. We can work with local businesses looking to attract Frederick customers or one that operates throughout Maryland.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Frederick-Maryland.webp"
                                alt="Frederick Maryland"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Frederick SEARCHES INTO CUSTOMERS
                    </Typography>
