...
export const WhyGeekonomyItems = [
  {
    icon: Target,
    title: "A Strategy Built Around Your Business Goals",
    desc: [
      "Each business has a distinct search environment. We will pinpoint the obstacles preventing your website from ranking where it should, identify where your competitors are capturing market share and determine which opportunities will work hardest to grow your business."
    ]
  },
  {
    icon: Search,
  ...
  },
  {
    ...
    desc: [
      "A well-structured website enables search engines to better understand your web pages and to easily browse your entire website. We fix technical concerns that impact crawling and indexation, usability and surfing performance, mobile usability and organic visibility."
    ]
  },
  {
    icon: MapPin,
    title: "Local SEO That Strengthens Your Frederick Visibility",
    desc: [
      "If your business operates in Frederick and the local surrounding areas, showing up in local search results can directly affect calls, visits, and enquiries. Our formula blends local optimization, pertinent content, and authority boost tactics to get your business showing up for the precise searches you want."
    ]
  },
  {
    icon: Eye,
