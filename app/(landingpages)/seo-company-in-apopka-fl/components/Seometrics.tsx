...
import { Items } from "../const/Seometrics";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Rankings are just one of many metrics that SEO performance should be measured by. Geekonomy will keep track of many different metrics so you can see how well your website performs in organic search and where further opportunities exist.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          When you track several different areas of search performance, an Apopka FL SEO company can go further than ranking reports to measure the impact of organic search on your overall digital marketing objectives.
        </Typography>
      </div>
    </section>
  );
