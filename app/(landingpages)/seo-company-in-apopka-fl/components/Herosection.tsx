                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                          Apopka SEO Company{" "}
                          <span className="text-[#69AE44]">Built to Drive Local Business Growth</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Your customers are searching for the products and services that you offer on the internet. If your website does not show up when they search, they may end up buying from your competition. Geekonomy can help you get found on the searches with easy-to-understand SEO techniques tailored to your service, target customer, and local area.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          At Geekonomy, a professional SEO Company in Apopka, we do not just focus on boosting site traffic. We develop campaigns that ensure your business gets to the people who are actually looking for your services. Technical SEO, on-page optimization, content strategy, local search all aspects of our SEO campaign are built around your business objectives.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Our methodology applies local search engine optimization building blocks along with more aggressive organic search marketing initiatives to establish a more powerful presence. Whether you are a new website, attempting to improve older rankings, or trying to drive more highly qualified leads from the search engines.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Having an optimized SEO strategy in place, your business can increase the exposure for related searches, gain higher type-in traffic, and generate more conversions in the long run.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.7] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Apopka.webp"
                                alt="Apopka"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS APOPKA SEARCHES INTO CUSTOMERS
                    </Typography>
