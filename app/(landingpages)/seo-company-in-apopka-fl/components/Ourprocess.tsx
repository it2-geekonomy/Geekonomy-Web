      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            How Our SEO Process Works as Apopka SEO Company
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            An SEO strategy is not something that can be implemented on its own; it involves a process of research, optimization, content, and ongoing analysis. Geekonomy uses a proven, step-by-step process to look for opportunities, optimize your site, and develop your website's comprehensive organic search profile for your company.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          This way, Geekonomy can also plan the first steps of its SEO campaign based on research and indicators instead of conjecture. Every step is indeed used to enhance and strengthen your business‘s online presence.
        </Typography>
