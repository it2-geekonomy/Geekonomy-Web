      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Local Keyword Strategy for Apopka Business
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Local SEO begins by researching how your ideal customers are already searching for your products and services.Geekonomy will create a cross-section of your keywords that we will use to tie your essential services to potentially self-targeted location searches.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          Geekonomy involves service keywords, location, search intent and other supporting information in order to build a local keyword strategy that can be adapted according to developments within your business and the search environment.
        </Typography>
      </div>
    </section>
  );
