...
import { Items } from "../const/Whyneedseo";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Consumers frequently use search engines to locate products, services, and local companies. Being visible in the organic search results can increase the chances that your business will be noticed when the consumer is researching, and may provide them the information they need to make a contact decision before they ever pick up the phone.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          In a local search fight of local Apopka SEO services, an Apopka SEO Company with experience may offer a framework that can be used to improve site visibility, better direct messaging to relevant groups of audience, and offer additional consumer insight.
        </Typography>
      </div>
    </section>
  );
