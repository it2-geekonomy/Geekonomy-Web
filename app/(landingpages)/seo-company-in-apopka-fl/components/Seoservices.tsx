      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Our SEO Services in Apopka
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            It takes more than a handful of keywords for a successful SEO campaign. Geekonomy blends local, on-page, technical, and content strategies for a more powerful search presence for Apopka customers. Custom services are based on your website, industry, competition, and business goals.
          </Typography>
        </div>
