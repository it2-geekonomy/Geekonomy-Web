                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#69AE44]/30 px-4 py-2 backdrop-blur-sm">
                            ...
                            <Typography variant="overline" className="text-white text-nowrap">
                              Rocky River SEO Agency
                            </Typography>
                        </div>

                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                          Rocky River SEO Company{" "}
                          <span className="text-[#69AE44]">That Drives Growth For Local Businesses</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          If your business relies on custom in Rocky River and the surrounding area, appearing in local searches when potential customers are looking for your products or services can be invaluable. Geekonomy enables your company to establish a more authoritative local search presence by optimizing your website, Google Business Profile, local content, citations and other search factors.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          About our local SEO Company Rocky River OH Our local SEO company is all about bringing your business to the people who are looking for your specific product or service. We avoid general SEO techniques which might drive visitors from other locations to your site. We tailor our campaigns to optimize for local search intent and make sure that your direct service area is where your business gets noticed.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Our method integrates technical SEO, locally targeted content, on-page optimization, enhancements to your Google Business Profile, authority development, and reporting to establish an enduring platform from which your business gains increased presence in organic and local search.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Rocky-River.webp"
                                alt="Rocky River"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Rocky River SEARCHES INTO CUSTOMERS
                    </Typography>
