      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Our Rocky River Local SEO Process
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            A well-rounded local SEO campaign requires a defined process. The Geekonomy process takes a systematic approach to reviewing your current online presence, identifying areas for improvement, making changes and tracking results.
          </Typography>
        </div>
