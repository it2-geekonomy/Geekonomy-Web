      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy for Local SEO?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Selecting an SEO partner, therefore, is not about finding someone who can slot the right keywords into your website. It should be built in a way that puts your website at the center of your business, your customers, your foot-print area, and the search opportunities for volume that can drive growth.
          </Typography>
        </div>
