      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Company Rocky River OH for Different Industries
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Because businesses differ across various markets, every industry should show a unique strategy that caters for the products and services it provides, the unique type of customer it targets and their personal search behavior. For this reason Geekonomy produces tailored campaigns related to the type of business you run within your community.
          </Typography>
        </div>
