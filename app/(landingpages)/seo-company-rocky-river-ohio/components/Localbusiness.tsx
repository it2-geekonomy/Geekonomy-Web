...
import { Items } from "../const/Localbusiness";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Local Businesses Need More Than Basic SEO
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Succeeding in local search is more than just securing a few keywords. Customers research local businesses using a variety of search phrases, sources and devices, so it‘s important to ensure your online visibility communicates relevant and coherent information all the way through.
          </Typography>
        </div>
