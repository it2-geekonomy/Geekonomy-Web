      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            A thriving SEO campaign requires an articulated process linking technical effort with the queries your prospective customers are executing. Geekonomy relies on a methodical approach for establishing lasting search visibility and converting that visibility into business.
          </Typography>
        </div>
