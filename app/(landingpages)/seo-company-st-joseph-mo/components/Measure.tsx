      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Measure What Your SEO Investment Produces
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Data, Customers, and ROI. SEO should facilitate quantifiable business development, not just higher search rankings. We monitor the data that demonstrates your site‘s search performance and illustrates how this visibility leads to genuine opportunities for your business in St. Joseph.
          </Typography>
        </div>
