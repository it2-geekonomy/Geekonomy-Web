      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            St. Joseph SEO Strategy Focused on Local Customers
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Getting found for broad keywords is just one of many factors that will lead to a successful search engine optimization campaign. Your site will also need to rank when consumers in St. Joseph are searching for the products & services you offer. 
          </Typography>
          <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
            Our approach integrates local search indicators, context-relevant content, and technical optimization to bring your business in front of high buying intent customers.
          </Typography>
        </div>
