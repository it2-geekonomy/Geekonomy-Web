      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services Built for St. Joseph Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Your customers are already searching for what you offer online. Our SEO services are how you get found when they do. We get you found in Google maps, the local results as well as the traditional organic listings.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
         As a St. Joseph SEO Company, Geekonomy offers these services in a unified approach that will increase your local visibility and bring quality targeted traffic to your site.
        </Typography>
      </div>
    </section>
  );
