          ...
          <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-[#69AE44]/25 blur-[6.25rem]" />
            ...
            <div className="relative ">
                <Typography variant="display-2xl" as="p" className="text-white  leading-tight">
                  Ready to Grow Your Business in St. Joseph?
                </Typography>

                <Typography variant="body-xl" className="mx-auto mt-5 max-w-4xl leading-relaxed text-white/90">
                  Your customers are looking for your type of business every day. Increased visibility in Google allows you to be there when they are searching for your products or services.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  Geekonomy bases your SEO strategy on your business goals, existing local competition, and the St. Joseph search market turning targeted search visibility into more calls, enquiries, and leads.
                </Typography>
