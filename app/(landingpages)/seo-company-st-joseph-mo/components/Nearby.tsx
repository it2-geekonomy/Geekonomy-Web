      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="order-1 w-full lg:max-w-2xl">
            ...
            >
              Areas We Serve Around St. Joseph, MO
            </Typography>
            <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
              All of our local SEO campaigns are designed to take your business to the customers of St. Joseph and all the other cities connected to the communities around them. 
            </Typography>
            <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
              We focused on location relevance based on where you actually do business instead of providing a generic solution.
            </Typography>
          </div>
          ...
          <div className="order-2 mx-auto w-full max-w-95 lg:mx-0 lg:max-w-130 lg:justify-self-end">
            <div className="aspect-[6/4] w-full overflow-hidden rounded-[1rem] border border-white/10 bg-white/5 shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
              <img
                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Saint-Joseph-area.webp"
                alt="St. Joseph areas"
