      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as St. Joseph SEO Company That Understands Market?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Local SEO is most effective when it lines up with the market you‘re targeting. If you want to succeed competing in St. Joseph, you‘ll need more than just the basics of local search optimization. You will need to know how searchers behave locally, why they search for what they do, who your local competitors are, and what services those searchers are looking for.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
         Geekonomy will grow to be the St. Joseph SEO Company that delivers search visibility and, in a locally targeted, small, calculated way, converts this into steady business growth.
        </Typography>
      </div>
    </section>
  );
