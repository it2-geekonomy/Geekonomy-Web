    ...
    <section id="results" className="bg-black py-8 lg:py-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          >
           SEO for St. Joseph's Local Business Market
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
           St. Joseph has a complex business environment so an SEO strategy should take a broad view of how various types of customers search for local businesses. Geekonomy creates campaigns based on your business sector, your services, buyer intention and the local search possibilities which can lead to tangible increases in business.
          </Typography>
        </div>
