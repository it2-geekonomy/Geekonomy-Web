          ...
          <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-[#69AE44]/25 blur-[6.25rem]" />
            ...
            <div className="relative mx-auto max-w-5xl">
                <Typography variant="display-2xl" as="p" className="text-white  leading-tight">
                  Ready to Grow Your Search Visibility in Fredericksburg?
                </Typography>

                <Typography variant="body-xl" className="mx-auto mt-5 max-w-4xl leading-relaxed text-white/90">
                  Your perfect customer is looking for what you have to sell. A clever SEO strategy will improve your visibility in appropriate searches, drive the right visitors to your website and increase the volume of fresh leads.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  In the end, by setting up local SEO, technical SEO, content development, keyword research and optimization and conversion optimization Geekonomy develops an SEO strategy for your business.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  If you want to begin with local search, craft an optimization strategy for an existing website or improve your organic growth strategy, we are here to help.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  Get in touch with Geekonomy today for a tailored SEO plan that will increase your presence on the internet and generate new business in Fredericksburg, VA.
                </Typography>
