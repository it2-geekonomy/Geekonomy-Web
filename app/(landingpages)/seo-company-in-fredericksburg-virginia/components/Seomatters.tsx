      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why SEO Matters for Fredericksburg, VA Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Consumers turn to a search engine to find a product or service. Local businesses will have a better chance of getting to the first page of Google for people searching for your type of service in Fredericksburg, VA if you have a good organic ranking.
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            SEO is all about helping your company get in front of local visitors before they decide. Customers who are searching online, comparing providers and making up their mind want to discover your business when they look for products or services you offer not after.
          </Typography>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-center w-full max-w-95 mx-auto md:max-w-none md:mx-0 rounded-[1.25rem] bg-gradient-to-br from-[#69AE44] to-[#4d8a2f] p-7 ">
            ...
            <Typography variant="body-lg" className="mb-2 text-black/70">
              We help Fredericksburg businesses improve search visibility, attract the right customers, and grow with a tailored SEO strategy.
            </Typography>
            <a
              href="#contact"
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          SEO can be an effective channel to continuously reach out to customers looking for your services in and around Fredericksburg if it is done the right way.
        </Typography>
      </div>
    </section>
  );
