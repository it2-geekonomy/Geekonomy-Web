      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as Your Fredericksburg SEO Company?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            You need to be careful when selecting someone to be your SEO partner, since it’s not just your website you’re handing over; it’s your content, your business, and your presence online. Geekonomy approaches SEO from a strategic perspective. We bring a combination of tech skills, content, local searches, and conversion strategies.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          Looking for a <span className="text-[#FFFFFF] font-semibold">Fredericksburg SEO business?</span> Geekonomy can develop you with a structured plan of action that will optimize your search rankings and drive your larger marketing and lead generation objectives.
        </Typography>
      </div>
    </section>
  );
