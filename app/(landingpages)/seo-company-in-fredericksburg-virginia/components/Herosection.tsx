                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#69AE44]/30 px-4 py-2 backdrop-blur-sm">
                            ...
                            <Typography variant="overline" className="text-white text-nowrap">
                              Fredericksburg SEO Agency
                            </Typography>
                        </div>

                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                          Fredericksburg SEO Company{" "}
                          <span className="text-[#69AE44]">That Helps Businesses Get Found</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Conquer the digital realm Increase visibility, quality traffic and lead conversions by aligning your SEO strategy with your business goals. Geekonomy provides a holistic SEO strategy for boosting your search presence that brings data-driven, search engine optimization solutions that leverage local SEO, Technical SEO, content and conversions on your site.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          As Fredericksburg VA‘s number 1 SEO company, we already know how to target our potential customers. Our Fredericksburg VA SEO packages will target buyers who are actively looking for what you have to offer through some of the following methods of business redefining search localization, on-demand keywords and many more.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Fredericksburg.webp"
                                alt="Fredericksburg"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Fredericksburg SEARCHES INTO CUSTOMERS
                    </Typography>
