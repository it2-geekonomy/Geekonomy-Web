      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            SEOs are optimized for specific industries. Customer shopping experiences, search buyer intent, demand, and conversions are all different. Geekonomy creates a strategy based on how customers are looking up and finding your business.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          No matter your sector, Geekonomy can craft an SEO plan that is always tailored to the specific market, competitors, name, services and location, as effectively as your vision for your organization.
        </Typography>
      </div>
    </section>
  );
