      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Optimising SEO is not a “one site change” thing. Geekonomy has a process for your search presence, analysing what opportunities there are, what optimisations need to be taken, measuring their impact, and building an SEO roadmap for your organisation.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          This provides Geekonomy with the ability to create SEO campaigns that are relevant to real business objectives as well as give an opportunity for organic measurement and new sources of traffic.
        </Typography>
      </div>
    </section>
  );
