      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            How Our Henderson SEO Process Works
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            The search vision for your business in the beginning is especially important. Its the whole foundation of the optimization, and we truly know the process of the effective SEO Company Henderson Nevada businesses can work with.
          </Typography>
        </div>
