      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            When choosing an SEO company you‘re not getting a cookie cutter approach. Geekonomy employs a comprehensive strategy incorporating technical SEO, content, local search, and search intent to develop a plan toward your objectives.
          </Typography>
        </div>
