                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                          Henderson SEO Company{" "}
                          <span className="text-[#69AE44]">That Helps You Get Found & Grow</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Get more exposure, focused traffic and more leads! We create an SEO strategy tailored to meet your company‘s goals. As a results driven <span className="text-[#FFFFFF] font-semibold">Henderson SEO Company</span>, Geekonomy uses local SEO, search engine optimization and content strategy to optimize your web page for the most important keywords.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          If your goal is to improve your local rankings, increase inquiries from people seeking your business, or boost your organic visibility, we will create an SEO strategy customized to your industry, your competition, and your growth targets.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Henderson.webp"
                                alt="Henderson"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Henderson SEARCHES INTO CUSTOMERS
                    </Typography>
