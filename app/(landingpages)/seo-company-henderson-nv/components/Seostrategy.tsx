      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            A Complete SEO Strategy for Henderson Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            To achieve a powerful SEO campaign, keywords alone will not do it. Our <span className="text-[#FFFFFF] font-semibold">SEO Company Henderson NV</span> approach is to utilize a mixture of technical enhancements, quality content, local optimization, and link-building to build up a strong foundation that will result in consistent organic growth.
          </Typography>
        </div>
