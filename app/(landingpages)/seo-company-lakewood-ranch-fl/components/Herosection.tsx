                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Grow your online visibility, attract more qualified customers, and turn search traffic into real business opportunities with a results-focused <span className="text-[#FFFFFF] font-semibold">lakewood ranch seo company</span>. Geekonomy creates customized SEO strategies designed around your business, your customers, and the searches that matter most in Lakewood Ranch.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Whether you are a local service provider, professional firm, retailer, healthcare business, contractor, or growing company, our SEO approach combines local search optimization, technical improvements, content strategy, and conversion-focused optimization to help your website compete in organic search.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Looking for an experienced <span className="text-[#FFFFFF] font-semibold">seo company lakewood ranch fl</span> businesses can turn to for a customized growth strategy? Geekonomy can help you build a stronger search presence and create a website that is positioned to attract the right audience.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Lakewood-Ranch.webp"
                                alt="Lakewood Ranch"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Lakewood Ranch SEARCHES INTO CUSTOMERS
                    </Typography>
