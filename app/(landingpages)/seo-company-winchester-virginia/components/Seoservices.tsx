      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services Built for Winchester, VA Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            To be considered a strong SEO strategy, a website requires more than strategic keywords. It must also communicate the nature of your company to search engines while creating trust so visitors will locate, contact and transact with you. Geekonomy merges a number of SEO services to establish a stronger organic presence for businesses in search of customers around Winchester, VA.
          </Typography>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-center w-full max-w-95 mx-auto md:max-w-none md:mx-0 rounded-[1.25rem] bg-gradient-to-br from-[#69AE44] to-[#4d8a2f] p-7 ">
            ...
            <Typography variant="body-lg" className="mb-2 text-black/70">
              We help Winchester businesses improve search visibility, attract the right customers, and grow with a tailored SEO strategy.
            </Typography>
            <a
              href="#contact"
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          These activities collectively form a unified search strategy, rather than unrelated, departmental activities. Whether you are looking for a local search visibility strategy or an overall organic growth plan, Geekonomy can develop a solution tailored to your business and target audience.
        </Typography>
      </div>
    </section>
  );
