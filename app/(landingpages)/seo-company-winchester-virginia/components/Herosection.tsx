                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          They are already searching online for the product or service you sell. Their challenge is to make sure your business is there when they do. Geekonomy offers SEO approaches tailored to enable businesses to enhance organic search visibility, to draw pertinent web site traffic, and to convert searchers into leads.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Choosing your <span className="text-[#FFFFFF] font-semibold">SEO company Winchester</span> is to work with for continued success after the initial campaign should be based on more than SEO rankings alone. Our strategy is to develop a solid base in Google. We integrate a comprehensive blend of; technical SEO, local search optimization, good quality content, keyword targeting and website conversion improvements.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          If you‘re a local business that faces customers from all over Winchester or you have a niche target market in certain local areas of Winchester, VA. We craft an SEO plan based upon your field, competitors, audience and goals. The final product is a search engine plan specifically designed to match your potential customers.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Winchester.webp"
                                alt="Winchester"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Winchester SEARCHES INTO CUSTOMERS
                    </Typography>
