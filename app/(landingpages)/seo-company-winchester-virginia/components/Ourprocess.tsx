      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            How Our Winchester SEO Strategy Works
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Your SEO strategy is most effective when it‘s designed to achieve a single business goal. Rather than following a generic checklist, Geekonomy tailors your SEO campaign based on your website, your rivals, your potential clients, and opportunities in the Winchester area.
          </Typography>
        </div>
