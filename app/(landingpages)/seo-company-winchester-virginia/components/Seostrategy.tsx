      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            What Makes a Winchester SEO Strategy Effective?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            SEO success is constructed on more than just stuffing keywords throughout your pages. Search engines want to understand your site, visitors want to find relevant content, so a solid strategy combines the two.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          Once combined, these factors form a cohesive Winchester SEO that will help increase your online visibility, bring targeted visitors to your site and generate more business opportunities.
        </Typography>
      </div>
    </section>
  );
