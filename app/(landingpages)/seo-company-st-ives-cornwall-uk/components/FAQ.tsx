      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-4xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            SEO St Ives involves technical SEO, keyword audit, on-page SEO, content, local SEO, optimization of your Google Business Profile, link-building and ongoing analytics & performance tracking. The precise approach will be determined by your website, business sector, target customers and overall objectives.
          </Typography>
        </div>
