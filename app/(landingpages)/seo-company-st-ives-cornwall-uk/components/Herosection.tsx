                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                          St Ives SEO Company{" "}
                          <span className="text-[#69AE44]">That Helps Your Business Get Found and Grow</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Increase the visibility of your business to more of the right people searching online for your products and services with a customized <span className="text-[#FFFFFF] font-semibold">SEO St Ives</span> campaign built around your market, customers and business objectives.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Focusing on areas that can attract additional relevant organic traffic and potential clients to your business from enhancing the search visibility of your website to capturing those essential local searches we’μlmput our seo efforts where they matter most. Our SEO strategy integrates technical and on-site optimization, keyword analysis, valuable content, local SEO and continuous monitoring and improvement.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          As a well-established <span className="text-[#FFFFFF] font-semibold">SEO Company St Ives</span>, we consider boosting rankings is just the beginning. We design the best SEO strategies based on search intent and customer journey. It will increase targeted traffic to your website and make sure users can easily move forward.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/St-Ives.webp"
                                alt="St Ives"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS St Ives SEARCHES INTO CUSTOMERS
                    </Typography>

                    <div className="flex max-w-xl flex-wrap justify-center gap-4 lg:justify-start">
