          ...
          <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-[#69AE44]/25 blur-[6.25rem]" />
            ...
            <div className="relative mx-auto max-w-5xl">
                <Typography variant="display-2xl" as="p" className="text-white  leading-tight">
                  Ready to Improve Your Search Visibility in St Ives?
                </Typography>

                <Typography variant="body-xl" className="mx-auto mt-5 max-w-4xl leading-relaxed text-white/90">
                  Customers are actively looking for your goods and services. A targeted SEO campaign will help your business rank higher for relevant searches and give you more chances to convert visits into enquiries.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  If you require more localized visibility, more effective service pages or an effective full SEO approach, Geekonomy will help you see what opportunity there is and help you develop an action plan to achieve your objectives.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  Discuss your website, intended audience and how you want your website to rank highly on the search engines with one of our advisors.
                </Typography>
