      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services for League City Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            League City companies and organizations compete for customers across the web in Google Search, Google Maps, and local search. Our SEO services are built around how residents of League City search for local businesses & services in order to help your website attain visibility for relevant, high-intent searches.
          </Typography>
        </div>
