                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            League City SEO Company{" "}
                            <span className="text-[#69AE44]">That Turns Searches Into Customers</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Get your <span className="text-[#FFFFFF] font-semibold">League City</span> business discovered by the customers who are proactively searching for your products/services. Our SEO services use a combination of local search optimization, technical overhauls, content, and conversion strategies to develop an increased presence on Google Search and maps.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          As an established <span className="text-[#FFFFFF] font-semibold">SEO Company in League City, TX</span> we know which searches are most relevant to your business – not just whether it‘s getting you more hits. Whether you‘re looking for better local rankings or more calls, enquiries or highly targeted leads, every campaign is tailored to suit your market, your competition and your business objectives.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/League-City.webp"
                                alt="League City"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS League City SEARCHES INTO CUSTOMERS
                    </Typography>
