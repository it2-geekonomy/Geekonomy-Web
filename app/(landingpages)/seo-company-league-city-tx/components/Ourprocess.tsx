      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Our SEO Process as League City SEO Company
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
           The key to an effective SEO campaign is analyzing where your League City business is now and what opportunities are best. Our process integrates research, optimization, content and ongoing performance improvements:
          </Typography>
        </div>
