      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as League City SEO Company
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Selecting an SEO company isn‘t just about identifying someone who can move your rankings. Your approach must be driven by your desired business outcomes, your customers, and the nature of competitive search in League City. As a <span className="text-[#FFFFFF] font-semibold">League City SEO company</span>, that‘s precisely what we aim to achieve.
          </Typography>
        </div>
