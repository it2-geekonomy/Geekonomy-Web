      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Search Engine Optimization should be gauged by more than your ranking. We monitor those metrics that show you if the search visibility you are paying for is bringing the right people to your League City business.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          Connecting the results from search performance to enquiries and leads shows you how your SEO activity is contributing to growth within League City.
        </Typography>
      </div>
    </section>
  );
