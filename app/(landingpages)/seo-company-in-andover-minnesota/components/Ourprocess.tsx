      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            How Our Andover SEO Process Works
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            A solid search engine optimization campaign begins by knowing your website, your competitors, your customers and your business objectives. Geekonomy employs a systematic approach to review opportunities, prioritize optimization and continually improve your strategy.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          This type of planning allows Geekonomy to formulate an SEO campaign driven by your business rather than a standard campaign.
        </Typography>
      </div>
    </section>
  );
