          ...
          <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-[#69AE44]/25 blur-[6.25rem]" />
            ...
            <div className="relative mx-auto max-w-5xl">
                <Typography variant="display-2xl" as="p" className="text-white  leading-tight">
                  Ready to Grow Your Visibility in Andover?
                </Typography>

                <Typography variant="body-xl" className="mx-auto mt-5 max-w-4xl leading-relaxed text-white/90">
                 Your customers are searching for your products and services now on the internet. An effective SEO campaign can make your business easier to find, draw the right visitors to your site and generate more opportunities to convert searches into sales.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  Whatever you require local SEO, technical, content or a whole search strategy, Geekonomy will be able to pinpoint the opportunities that are right for your business.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  Develop an SEO strategy based on your company, industry & customers. Begin with a strategic SEO approach that is centered on your company, industry and the customers that you intend to communicate.
                </Typography>
