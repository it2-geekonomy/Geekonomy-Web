      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Strategies Built Around Your Business
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
           No two companies draw in customers in the same way. The keywords, competition, buying cycle and content requirements for a contractor could be very different to that of a healthcare provider, online retailer or professional services company.
          </Typography>
          <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
            A “one size fits all” approach does not exist with Geekonomy – we will build your SEO campaign according to your business model, the services/products you are offering, the target audience and the market.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          No matter if you‘re based in Andover or catering to a broader audience, our SEO strategies are determined by the searches relevant to you.
        </Typography>
