      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Complete SEO Services for Andover Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            To succeed in the search engines, isn‘t about keywords alone. Geekonomy brings together on-site, content marketing, local optimization and authority signals to build a better search profile for your Andover business.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          Offers a combination of these services and thereby provides your enterprise with a comprehensive SEO base rather than a one-sided optimization approach.
        </Typography>
      </div>
    </section>
  );
