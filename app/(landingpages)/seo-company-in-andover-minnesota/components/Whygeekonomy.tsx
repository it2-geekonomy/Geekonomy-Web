      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Businesses Choose Geekonomy for Andover SEO
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
           Selecting an SEO partner is not just about responses to higher rankings. Your approach should be specific to your objectives, the way your customers search, your website, and the prospects of your market.
          </Typography>
          <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
           Geekonomy synthesises these factors with an engineering approach, providing a workable SEO framework aimed at achievable growth.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
         When looking for an <span className="text-[#FFFFFF] font-semibold">SEO Company Andover</span>, Geekonomy can develop a plan around where your business is at the moment and the search opportunities you want to go for.
        </Typography>
      </div>
    </section>
  );
