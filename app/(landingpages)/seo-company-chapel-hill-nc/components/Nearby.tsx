      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="order-1 w-full lg:max-w-2xl">
            ...
            >
              Areas We Serve Near Chapel Hill
            </Typography>
            <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
             Many of the businesses in Chapel Hill use to attract customers from even further away. 
            </Typography>
            <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
              Geekonomy can help extend your local search presence into surrounding towns and cities, without straining your SEO efforts on places and people that are less relevant.
            </Typography>
          </div>
          ...
          <div className="order-2 mx-auto w-full max-w-95 lg:mx-0 lg:max-w-130 lg:justify-self-end">
            <div className="aspect-[6/4] w-full overflow-hidden rounded-[1rem] border border-white/10 bg-white/5 shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
              <img
                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Chapel-Hill-areas.webp"
                alt="Chapel Hill areas"
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          If your business is targeting several towns and communities in and around Chapel Hill, North Carolina , we can implement a local targeted SEO approach that will allow you to establish your presence in your entire service area without creating duplicate or thin location pages.
        </Typography>
      </div>
    </section>
  );
