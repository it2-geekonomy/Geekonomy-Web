    ...
    <section id="results" className="bg-black py-8 lg:py-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          >
           SEO for Different Chapel Hill Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            No two businesses are alike; we each have unique customers, competitors and search opportunities. Geekonomy recommends SEO actions that are relevant to your business niche, offerings, customer persona and growth objectives, instead of a generic list.
          </Typography>
        </div>
