      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as Your Chapel Hill SEO Company?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Partnering with the right local SEO company can be one of the most important decision making factors for your local business. Geekonomy offers a comprehensive approach to local search marketing that takes strategic SEO planning, technical optimization, content creation and local search knowledge into account.
          </Typography>
        </div>
