...
import { Items } from "../const/Resultmatters";

export default function ResultMatters() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Results That Matter to Your Chapel Hill Business
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Your SEO should accomplish much more than simply placing you higher up on the search engine results page. Well thought out SEO should enable your business to be more easily discovered, target the right groups of people, and open more channels for inquiries and sales.
          </Typography>
        </div>
