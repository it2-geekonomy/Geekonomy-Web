                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Be discovered by potential clients searching for what you have to offer. Strategic SEO that will boost your location visibility and bring targeted local traffic and more leads to your business is what Geekonomy has to offer to Chapel Hill companies.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          We are a search focussed SEO Company Chapel Hill NC. We use local SEO, technical SEO, content marketing, keyword research, and link building to develop a search strategy that matches your business objectives. We develop an SEO plan around your business objectives, whether you‘re trying to boost your Google rankings, attract more local customers, or develop sustainable organic growth.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Chapel-Hill.webp"
                                alt="Chapel Hill"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Chapel Hill SEARCHES INTO CUSTOMERS
                    </Typography>
