                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                          Mentor SEO Company{" "}
                          <span className="text-[#69AE44]">That Helps Your Business Get Found</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Your customers are using search engines to find the products and services they want. Having a strong search presence will ensure that your business will be visible during those searches. We optimize our SEO campaigns to increase your visibility in Google, draw high-quality local traffic, and convert more searches into customers.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          As an experienced <span className="text-[#FFFFFF] font-semibold">SEO Company Mentor OH</span>, Geekonomy concentrates on the critical elements for your business:- website optimization, local search ability, content, technical SEO and continual performance enhancement. We develop tailored strategies based on your services, people, and business objectives rather than any generic template.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          No matter if you‘re trying to promote your business to new customers in Mentor or increase your presence throughout surrounding markets, a solid SEO plan will be able to establish your business as a more dominant and stable entity in natural search.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Mentor-OH.webp"
                                alt="Mentor OH"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Mentor SEARCHES INTO CUSTOMERS
                    </Typography>
