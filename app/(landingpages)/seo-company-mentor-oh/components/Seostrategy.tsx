      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            What Our Mentor SEO Strategy Focuses On
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            The key to any good SEO is to know how your customers search and what they are looking for. Rather than the generic approach that you often see companies taking, here, we will think about the search factors that are most relevant to your site, services, and target market.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          This way a Mentor SEO Company strategy can still take into account the elements of importance to your business and at the same time, lay down the groundwork needed for sustained, long-term organic search visibility.
        </Typography>
      </div>
    </section>
  );
