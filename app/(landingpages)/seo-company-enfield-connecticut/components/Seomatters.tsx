      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services Built for Enfield, CT Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            All good SEO should be designed around how your customers actually search for businesses in your area. Geekonomy offers bespoke SEO campaigns, which enable businesses to build on their visibility within the relevant Google results pages, while simultaneously developing an experience on the website that will convert visitors into new customers.
          </Typography>
        </div>
