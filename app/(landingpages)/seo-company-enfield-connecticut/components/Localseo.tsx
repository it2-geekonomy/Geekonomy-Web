      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Local SEO for Enfield Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Local SEO allows a business to be found when a potential customer searches for a particular good or service in their geographical location. Geekonomy creates a local search plan that will optimize your visibility in Google Search as well as other major local discovery channels. If your business is looking to secure location-based search prominence in Connecticut an seo company in enfield ct may be exactly right.
          </Typography>
        </div>
