      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO for Different Enfield Business Types
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            No two businesses have the same customers, services, competitors and how people search. Geekonomy creates SEO campaigns tailored to these differences rather than a one size fits all package of templates. Be it consumers, professionals or business to business, we craft campaigns which match your services to demand.
          </Typography>
        </div>
