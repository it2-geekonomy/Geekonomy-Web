      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Our Enfield SEO Services
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Geekonomy offers an integrated SEO service to increase your website‘s visibility and content relevance to attract and convert more high-quality prospects. Rather than focusing on one single optimization, Geekonomy works at technical, content, local search optimization and constant tracking level, to strengthen your natural search machine.
          </Typography>
        </div>
