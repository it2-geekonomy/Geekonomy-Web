                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          When potential Customers are searching on Google for Products or Services in Enfield your Business must show up.Geekonomy assists Local Businesses in Enfield to improve their organic listing, bring relevant site visitors, and convert search traffic to leads. We develop strategies based on your business goals, customer profile, competition and local SEO opportunities.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          We don‘t just focus on keywords, we work across the spectrum of technical seo, local optimization, content, on page and conversion lead recommendations to build a more robust presence on the search engines. If you are looking for a <span className="text-[#FFFFFF] font-semibold">seo company in enfield ct</span>, Geekonomy will create a strategy tailored around your specific needs and your ideal customer.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          If your business is a small, expanding local business or an established company looking to improve your web presence, our goal is to make it simple for prospective customers to find the services you provide at the exact time they are searching for them.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Enfield.webp"
                                alt="Enfield"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Enfield SEARCHES INTO CUSTOMERS
                    </Typography>

                    <div className="flex max-w-lg flex-wrap justify-center gap-4 lg:justify-start">
