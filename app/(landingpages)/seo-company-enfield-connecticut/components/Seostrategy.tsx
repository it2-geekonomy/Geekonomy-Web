      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Your Enfield Business Needs a Local SEO Strategy
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            When searching for local businesses, people are more likely to use search engines first, looking for things like local businesses, to evaluate your competition or get more information to make buying decisions. That‘s where a strong local SEO strategy helps your business become visible for the relevant searches in your area.
          </Typography>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-center w-full max-w-95 mx-auto md:max-w-none md:mx-0 rounded-[1.25rem] bg-gradient-to-br from-[#69AE44] to-[#4d8a2f] p-7 ">
            ...
            <Typography variant="body-lg" className="mb-1 text-black/70">
              We help Enfield businesses improve search visibility, attract the right customers, and grow with a tailored SEO strategy.
            </Typography>
