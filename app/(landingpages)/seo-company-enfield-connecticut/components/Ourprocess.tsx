      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            How Geekonomy Builds an SEO Strategy for Enfield
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Getting your keywords on your website is only the first step and is not enough to produce successful SEO. Geekonomy has a structured approach that incorporates research, site analysis and technical SEO, content creation and optimization, local and regional SEO, and reports and analysis so that each campaign is tailored to the business objectives and specific online shopping behavior of your customers.
          </Typography>
        </div>
