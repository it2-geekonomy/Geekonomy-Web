      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            What Makes Geekonomy Different?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Getting an SEO partner is not about selecting a company that can even boost rankings. Your SEO technique should assist your general business objectives by bringing relevant visitors to your site, and engaging them in activities that will grow your business. Geekonomy provides tailored SEO solutions considering the type of your business, your niche and your marketplace.
          </Typography>
        </div>
