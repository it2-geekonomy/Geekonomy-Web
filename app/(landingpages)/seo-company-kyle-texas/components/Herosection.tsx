                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Get discovered by more prospective clients looking for what you have online. Geekonomy offers tailored SEO campaigns to optimize you on Google, bring relevant local visitors, and convert searchers into leads.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          <span className="text-[#FFFFFF] font-semibold"></span>Our Kyle TX seo company combines local seo with technical optimization, content strategy, keyword research and conversion focused improvements to create a stronger rank presence for your business. Whether you are a new business trying to gain visibility or a good business competing for valuable local searches, our approach is geared to your objectives and market.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Searching for an SEO agency you can trust to implement a strategic, long-term plan? Find out how Geekonomy can discover the highest SEO opportunities for your website and develop a plan based on your industry, competition and customers.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Kyle.webp"
                                alt="Kyle"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Kyle SEARCHES INTO CUSTOMERS
                    </Typography>
