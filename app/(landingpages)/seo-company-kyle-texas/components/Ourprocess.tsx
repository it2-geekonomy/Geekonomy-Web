      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Effective SEO isn‘t just about stuffing keywords onto a site. It includes knowing where you‘re already ranked, finding gaps, optimising the site and content and monitoring success.
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Geekonomy implements a systematic SEO methodology that enables us to develop a focused plan of action to maximize organic search traffic and improve visibility.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          This will enable Geekonomy to continuously improve strategy in real time, according to your website‘s performance, search opportunities and business goals.
        </Typography>
      </div>
    </section>
  );
