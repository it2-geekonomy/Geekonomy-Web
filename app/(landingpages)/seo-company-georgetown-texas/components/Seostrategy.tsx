      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Strategies Built for Georgetown, TX Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            No two Georgetown businesses have the exact same customers, services, competitors or growth goals. For this reason, your SEO strategy needs to be tailored to your target market‘s search habits, and should not simply be a universal one size fits all approach.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          If done correctly, a seo company georgetown texas campaign can aim both at rankings and a positive experience after the click.
        </Typography>
