      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Our Georgetown SEO Services
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Your SEO campaign needs to do more than just target keywords. A comprehensive approach integrates your website’s technical optimization, helpful content, local signals, and authority building to give your business a higher chance of organic growth. Geekonomy builds these factors to match your company objectives and target market.
          </Typography>
        </div>
