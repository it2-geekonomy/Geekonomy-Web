...
import { Lists } from "../const/Localsearch";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Georgetown Businesses Need Local SEO
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Local customers tend to search for various things based on what they need and where they are. This is why local SEO is a good way to get noticed by customers in Georgetown. Using a specific regional approach allows search engines to recognize your service area and also provides your site with relevance to the user searching.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          If seeking a seo company georgetown tx, Geekonomy can use your business services, target customers, competitors and business goals in crafting a local SEO plan.
        </Typography>
