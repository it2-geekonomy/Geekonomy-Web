      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Great SEO is about the right process of linking research, technical optimisation, content, your local visibility and keeping track. Geekonomy has a step-by-step process that builds on each stage so that your strategy develops as your website and search data does.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          This formalized process helps the Georgetown seo company strategy so that it doesn’t get lost within a one-time optimization.
        </Typography>
