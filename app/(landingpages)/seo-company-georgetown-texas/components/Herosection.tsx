                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                          ...
                          <span className="text-[#69AE44]">That Drives Local Growth For Business</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          To be found where and when your future clients or customers are looking, your online visibility has to be there first. Geekonomy develops an SEO plan guided by search intentions, local pertinence, web presence, and quantifiable business goals. If you own a business in Georgetown, we can help you achieve just that with local focused optimization, enhancing your Google Business Profile, providing your consumers with service pages, and building technically optimized websites so that search engines and users alike can interpret your offer.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          The team at Geekonomy is a georgetown texas seo company that develops a search strategy that links your business with the right customers within Georgetown and nearby service areas. Rather than using standard optimization, we locate local opportunities, optimize key pages, enhance local signals, and modify the strategy over time by analyzing performance data.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          If you run a local business, whether it‘s a home service business, professional office, retail business, healthcare practice, contractor business, or another local business, the goal is always the same: develop sustainable organic visibility for qualified traffic, inquiries, calls, and conversions.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Georgetown.webp"
                                alt="Georgetown"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS GEORGETOWN SEARCHES INTO CUSTOMERS
                    </Typography>
