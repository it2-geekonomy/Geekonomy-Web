      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as Your SEO Company in Georgetown, Texas?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Selecting an SEO partner is not just a function to earn keyword positions. Your SEO help to what you want your business to achieve can connect the right kind of visitors to your site so they can support your customers and grow your organic business.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          When assessing a <span className="text-[#FFFFFF] font-semibold">seo company georgetown texas</span>, Geekonomy can shape a plan for your website, industry, target customer, and local growth plans.
        </Typography>
      </div>
    </section>
  );
