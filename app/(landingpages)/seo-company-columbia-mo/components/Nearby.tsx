      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="order-1 w-full lg:max-w-2xl">
            ...
            >
              Across Columbia and Nearby Areas We Serve
            </Typography>
            <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
              You can offer a localized SEO strategy to be found by customers in and near Columbia. Geekonomy helps businesses to gain search presence not just in Columbia, MO, but in the nearby neighboring areas.
            </Typography>
            <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
              We can target relevant searches across areas such as:
            </Typography>
          </div>
          ...
          <div className="order-2 mx-auto w-full max-w-95 lg:mx-0 lg:max-w-130 lg:justify-self-end">
            <div className="aspect-[6/4] w-full overflow-hidden rounded-[1rem] border border-white/10 bg-white/5 shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
              <img
                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Columbia-areas.webp"
                alt="Columbia areas"
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          Our process is to create true local relevance for each service area, not just write city names in copy. It’s part of how we help clients attract customers throughout Mid-Missouri, while still maintaining larger state-wide focus in the primary Columbia market.
        </Typography>
