      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as Columbia SEO Company That Understands Market
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Choosing an SEO partner is about more than hiring someone who will up your ranks. Your SEO campaign should be geared by the needs of your market, your customers, your competitors and the services you want to expand. Geekonomy combines these factors into an intensive campaign for Columbia,MO-based businesses.
          </Typography>
        </div>
