      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            A Columbia-Focused SEO Strategy
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Achieving ranking in Columbia, MO is not a matter of ticking off an SEO checklist. The prospective customer searches for keywords based on what we offer, where we offer it, and the intent to buy. Geekonomy creates SEO campaigns by delving into local search patterns to push your business into views that turn into leads.
          </Typography>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-center w-full max-w-95 mx-auto md:max-w-none md:mx-0 rounded-[1.25rem] bg-gradient-to-br from-[#69AE44] to-[#4d8a2f] p-7 ">
            ...
            <Typography variant="body-lg" className="mb-2 text-black/70">
              We help Columbia businesses build a stronger online presence with SEO strategies tailored to their goals. From improving search rankings to attracting local customers, we guide you toward better visibility, more qualified traffic, and steady business growth.
            </Typography>
            <a
              href="#contact"
