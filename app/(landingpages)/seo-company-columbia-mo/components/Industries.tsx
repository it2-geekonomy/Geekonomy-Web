    ...
    <section id="results" className="bg-black py-8 lg:py-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          >
           SEO for Different Columbia Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
           Since each business in Colombia has unique customers, competitors, and search opportunities. Geekonomy develops search engine optimization strategies based on your industry, services, location, and objectives rather than a one-size-fits-all approach.
          </Typography>
        </div>
