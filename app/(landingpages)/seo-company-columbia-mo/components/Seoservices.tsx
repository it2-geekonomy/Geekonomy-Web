      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services for Columbia, MO Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            An effective SEO campaign will drive targeted traffic to your website; targeted traffic being people who are searching for what you offer. Geekonomy integrates local and organic SEO to increase the visibility of your business on the searches that matter most to your business in Columbia, MO.
          </Typography>
        </div>
