      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
           The starting point for great SEO is to understand your business, your prospects and your competition. The process of Geekonomy is designed to play to your key strengths to maximize the organic visibility and drive quality leads in Columbia MO.
          </Typography>
        </div>
