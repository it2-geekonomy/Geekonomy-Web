                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          To get visitors to your Brentwood business you need more than a website. You need to be seen by searchers who are looking for what you sell. Geekonomy is a target oriented <span className="text-[#FFFFFF] font-semibold">Brentwood seo company</span> helping businesses improve their online visibility, drive highly relevant organic traffic and convert searchers into leads.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          We are experts in Local SEO, local search, content, conversion rate optimization, targeting approach, and more! Boost your business in the search engines with our comprehensive Local SEO for either a new or existing business. We develop a Local SEO strategy for your website based on your business goals, industry, competitors, and local presence.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          While competitors focus on shortcuts such as keyword stuffing or manipulating rankings, Geekonomy builds a sustainable search presence. Whether we’re tailoring optimization for your key service pages or strengthening local search signals, everything we do is engineered to bring business to you from the right prospect at the right moment.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Seeking a local <span className="text-[#FFFFFF] font-semibold">SEO company Brentwood CA</span> businesses can turn to to develop a personalized SEO plan? Geekonomy can assist in identifying opportunities, diagnosing search visibility problems, and developing a realistic plan for organic growth.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Brentwood.webp"
                                alt="Brentwood"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Brentwood SEARCHES INTO CUSTOMERS
                    </Typography>
