      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Local SEO for Brentwood, California Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Local Search Optimization Optimizing for Local Search For companies that provide services to residents of Brentwood, appearing in Local Search results will be a key element of developing your visibility online. Most consumers will turn to Google to find options, review businesses, access information and compare companies when making a decision on who to buy from.
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Local Search Optimization As your local search <span className="text-[#FFFFFF] font-semibold">seo company Brentwood CA</span> businesses turn to, Geekonomy hones the search engine optimization strategy that will draw your website, business listings, your content, and your presence in local search results aligned with what your customers need.
          </Typography>
        </div>
