      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            A defined process helps identify opportunities, prioritize areas for improvement, and measure results. The Geekonomy local SEO workflow clearly guides you from research to sustainability.
          </Typography>
        </div>
