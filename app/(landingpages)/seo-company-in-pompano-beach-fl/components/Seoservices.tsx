      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Our Local SEO Services in Pompano Beach
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Geekonomy offers a complete locally oriented SEO strategy that will reinforce your online presence and link your business to the people looking for your services and goods in Pompano Beach. We integrate on-web page optimization, local search techniques, content, technical improvements and continuous analysis to establish a more powerful search presence.
          </Typography>
        </div>
