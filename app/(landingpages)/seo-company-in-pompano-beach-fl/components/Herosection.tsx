                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Having a presence when local prospects in Pompano Beach search your type of business online can greatly impact your ability to generate highly targeted leads if you operate locally. Geekonomy can assist your business in gaining increased visibility in Google Search and within local search results by utilizing proven techniques based on data driven keyword research, on-site optimization, and local search relevance.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Unlike other <span className="text-[#FFFFFF] font-semibold">local SEO Companies in Pompano Beach, FL</span>, our services are not about the rankings. Instead we target the local search traffic that actually translates into your business objectives: your website traffic, phone calls, inquiries and conversions. We optimize your website and your Google Business Profile, create relevant content, all around your market and your business.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          No matter what type of local business you own, be it a service, professional business, retailer, contractor, or something else Geekonomy can greatly assist you in establishing yourself in Pompano Beach and connecting with people looking specifically for your services.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Pompano-Beach.webp"
                                alt="Pompano Beach"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS POMPANO BEACH SEARCHES INTO CUSTOMERS
                    </Typography>
