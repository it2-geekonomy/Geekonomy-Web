      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as Your Pompano SEO Company?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Selecting an SEO partner is not just about optimizing keywords. For instance, your SEO strategy should align with your business objectives, target audience, suite of services, and competitors. At Geekonomy, we tailor our local SEO services to help you improve in achievable ways that boost your traffic to turn into more leads.
          </Typography>
        </div>
