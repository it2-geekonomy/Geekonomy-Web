      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            The local SEO campaign is effective when it has a strategy that ties the search results directly to your customers’ needs. We, at Geekonomy, aim at providing a solid foundation for all aspects of your website and local SEO, instead of leaning on one optimization technique.
          </Typography>
        </div> 
