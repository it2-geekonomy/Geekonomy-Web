      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Businesses Need Local SEO in Pompano Beach
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Pompano Beach businesses then face tough competition for customers who are searching on Google for local services, products or businesses. Absent an effective local SEO strategy, your site might not show up for searches with high local and commercial intent.
          </Typography>
        </div>
