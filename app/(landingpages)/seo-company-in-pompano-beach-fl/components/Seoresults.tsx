      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Local SEO Results You Can Track
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            There are better ways to measure a successful SEO campaign than keyword rankings. Geekonomy will analyze a number of metrics to tell you how your local search visibility is progressing and whether SEO is presenting your business with valuable opportunities.
          </Typography>
        </div>
