      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            A Data-Driven Local SEO Strategy for Pompano Beach Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Real local SEO goes beyond a handful of on-site improvements. Geekonomy leverages data, search trends, competitor information and performance analysis to craft a plan that can evolve with your business. Each phase is dedicated to identifying opportunities, deploying impactful enhancements and tracking success.
          </Typography>
        </div>
