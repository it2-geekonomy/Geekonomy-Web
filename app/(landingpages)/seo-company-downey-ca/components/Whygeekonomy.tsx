      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy For Downey SEO Company
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          Need a <span className="text-[#FFFFFF] font-semibold">seo company downey ca?</span> Geekonomy is the right place for you. We work on creating a tailored plan to align search visibility with your overall business objectives.
        </Typography>
      </div>
    </section>
  );
