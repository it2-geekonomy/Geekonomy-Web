      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO for Different Downey Businesses
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
         From a local service business to an ever-growing organization, Geekonomy can tailor an SEO campaign to your unique market. From a <span className="text-[#FFFFFF] font-semibold">downey seo company</span> to a local search, whether you’re a local-to-only search engine relying on free advertising, Geekonomy can get your website linked to the right searches and lead them to a conversion.
        </Typography>
      </div>
    </section>
  );
