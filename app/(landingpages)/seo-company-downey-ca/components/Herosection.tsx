                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Your consumers are looking online for the products and solutions you provide. Geekonomy is able to help organizations increase their ranking in Google Search and local search results with personalized SEO campaigns tailored to their objectives, target market, and industry.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Being a top <span className="text-[#FFFFFF] font-semibold">seo company</span>, <span className="text-[#FFFFFF] font-semibold">downey ca</span>, we know that SEO is not about just traffic. Our strategy for search engine optimization integrates local SEO, technical SEO, paid keyword targeting, on-site content, and iterative conversion enhancements to attract those who are searching for what you have to offer.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Whether you are a small business, local provider, professional service, retailer, healthcare provider or brand in expansion, our <span className="text-[#FFFFFF] font-semibold">downey seo company</span> solutions are designed to increase your visibility and produce greater opportunities for qualified prospects to find and call your company.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Downey.webp"
                                alt="Downey"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Downey SEARCHES INTO CUSTOMERS
                    </Typography>
