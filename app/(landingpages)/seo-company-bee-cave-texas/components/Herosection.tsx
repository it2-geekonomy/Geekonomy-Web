                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          When people look for a service online, your business is in the prime position to stand out where the search is taking place. Geekonomy offers SEO solutions to help the business stand out in Google for their local area, as well as capitalize on the extra local traffic and get new leads out of the larger number of searches.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          As a <span className="text-[#FFFFFF] font-semibold">Bee Cave Texas</span> SEO Company, we work on all aspects that impact your presence in local and organic search: From your website architecture and onsite, to local SEO, your content, and search intent. Each tactic is designed to achieve your business, customers, competitors, and aspirations.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Bee-Cave.webp"
                                alt="Bee Cave"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Bee Cave SEARCHES INTO CUSTOMERS
                    </Typography>
