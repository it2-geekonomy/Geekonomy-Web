      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Our SEO Process for Bee Cave Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Successful SEO must begin with a wide knowledge of your website, market, competitors and customers. We follow a process to assist in finding opportunities, as well as making your website more findable through the search engines, and continually adapting your strategy.
          </Typography>
        </div>
