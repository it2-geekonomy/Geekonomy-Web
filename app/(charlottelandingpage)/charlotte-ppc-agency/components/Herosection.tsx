                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-xl" as="h1" className="text-white text-2xl sm:text-4xl lg:text-5xl leading-[1.1]">
                            Charlotte PPC Agency That Turns{" "}
                            <span className="text-[#69AE44]">Ad Spend Into Qualified Leads</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Make paid search a steady stream of targeted leads by running PPC campaigns that focus on your objectives. Geekonomy can help businesses in Charlotte improve Google AdWords, reach searches with purchase intent, increase conversions, and have a greater return from each dollar spent on paid search.
                        </Typography>

                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Whether it is campaign creation, keyword selection, continuous monitoring of campaigns, or optimization of the campaigns, we look only at the numbers that matter: <span className="text-[#FFFFFF] font-semibold">qualified leads,</span>  <span className="text-[#FFFFFF] font-semibold">conversion</span> rate, <span className="text-[#FFFFFF] font-semibold">cost per lead, and return on</span> ad spend.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[4/4.4] w-full max-w-[320px] overflow-hidden rounded-3xl border border-white/10 bg-white/5 mx-auto sm:max-w-[420px] lg:max-w-[520px] lg:mx-0">
                            <img
                                src="https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/herosectioncharlotte.png"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                        Every part of your paid search strategy, built to perform
                    </Typography>
