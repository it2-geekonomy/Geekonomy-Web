      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Marketing Services for Paving Contractors
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          An effective online marketing for paving contractors strategy integrates various channels to enable prospects to locate your company, assess your offerings, and proceed to get in touch.        
          </Typography>
          <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
          We tailor our digital marketing services to the process by which paving consumers research and select paving contractors, ensuring alignment with the paving industry standards and helping them find local paving contractors.        
          </Typography>
        </div>
