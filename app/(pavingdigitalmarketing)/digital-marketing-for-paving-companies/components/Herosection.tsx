                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#69AE44]/30 px-4 py-2 backdrop-blur-sm">
                            ...
                            <Typography variant="overline" className="text-white text-nowrap">
                                Paving Digital Marketing Agency
                            </Typography>
                        </div>

                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Digital Marketing for Paving Companies{" "}
                            <span className="text-[#69AE44]">That Drives More Local Leads</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Place your paving business in front of customers searching and browsing for paving, asphalt, driveway, parking lot, and other paving services during the paving season. Our digital marketing package utilizes a blend of SEO, local search marketing, paid advertising, and conversion optimization to get more high intent prospects to your website and turn online searches into calls, quote requests, and lucrative paving contracts.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            We focus your marketing on your services, service areas, target customers and growth objectives so your marketing is not just a traffic builder, it builds you a healthy, predictable pipeline of qualified paving leads.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/pavingherosection.png"
                                alt="Digital Marketing for Paving Company"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                        Every channel working toward one goal: more qualified paving leads
                    </Typography>
