      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy for Paving Marketing?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            A paving company can‘t do marketing just once in a while, it should be a marketing company that takes care of your marketing agenda. Geekonomy will prepare an online marketing plan according to your services, areas, competitors, lead-generation goals, and contractor marketing guidelines.        
          </Typography>
        </div>
