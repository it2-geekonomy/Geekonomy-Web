      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#69AE44]/30 px-4 py-2">
            ...
            A Digital Marketing Strategy Built Around Your Paving Goals
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          You need to develop your marketing plan with respect to the areas you wish to grow your paving company in and the specific services you wish to market through online marketing for paving companies, especially targeting local paving. We employ a targeted process in our online marketing for paving to help find opportunities that are aligned with your business objectives.        
          </Typography>
        </div>
