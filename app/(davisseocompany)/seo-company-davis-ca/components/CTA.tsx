          ...
          <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-[#69AE44]/25 blur-[6.25rem]" />
            ...
            <div className="relative ">
                <Typography variant="display-2xl" as="p" className="text-white  leading-tight">
                 Ready to Grow Your Search Visibility in Davis?
                </Typography>

                <Typography variant="body-xl" className="mx-auto mt-5 max-w-4xl leading-relaxed text-white/90">
                  Your next customers are searching for the products and services you sell. A strong SEO campaign can get your business ranked for those searches and make it easier for your next inquiry to find you.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                 Geekonomy develops SEO that is business-driven, market-driven and competitive. Whether local search or Google Maps, technical SEO, content, conversion, we focus on the work that can be translated into long term organic growth.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90 font-semibold">
                 Would you like to know where you could make improvements to your website?
                </Typography>
