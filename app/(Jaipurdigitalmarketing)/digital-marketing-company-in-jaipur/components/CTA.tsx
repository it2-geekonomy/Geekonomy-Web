        ...
        <div className="relative overflow-hidden border border-white/10 bg-[#69AE44]/20 px-8 py-16 text-center sm:px-16">
          <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-[#69AE44]/25 blur-[6.25rem]" />
            ...
            <div className="relative ">
                ...
                Turn More Jaipur Searches Into Customers     
                </Typography>

                <Typography variant="body-xl" className="mx-auto mt-5 max-w-4xl leading-relaxed text-white/90">
                People in Jaipur are already searching for the products and services you offer. The goal is to make sure they find your business when they’re ready to choose.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                Our digital marketing strategies combine SEO, local SEO, content, social media, and conversion-focused marketing to build stronger online visibility and bring more qualified customers to your business.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                Whether you're launching a new digital marketing campaign or looking to improve your existing results, we’ll identify the opportunities that can drive more traffic, leads, and growth in Jaipur.
                </Typography>
