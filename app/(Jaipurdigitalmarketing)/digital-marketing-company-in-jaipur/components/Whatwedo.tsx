    ...
    <section id="why" className="bg-black py-6 lg:py-10 ">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          All of your customers will go through several points of contact before spending. They could find you via Google Search, browse competitors’ sites and social assets, click an ad, read reviews, or come back because they saw your brand elsewhere.         
          </Typography>

          <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
          Geekonomy spans all these touchpoints with an integrated digital marketing approach. We develop strategies and deploy services to grow online presence, take advantage of relevant demand, drive qualified traffic, and optimize conversion funnels.
          </Typography>
        </div>
