                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Palm Harbor SEO Company{" "}
                            <span className="text-[#69AE44]">That Drives Local Business Growth</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Palm Harbor customers are looking for the products and services they want online. Developing a robust search engine optimization strategy ensures your business is visible when those searches happen Google local listing or organic search result, Google Maps or general search. As the leading <span className="text-[#FFFFFF] font-semibold">SEO company</span> for <span className="text-[#FFFFFF] font-semibold">Palm Harbor FL</span> businesses, Geekonomy marries local SEO, on-site optimization, content development, and authority building to boost your presence and ensure more targeted leads.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Our approach is not just about rankings. We ensure your website aligns with the right search intent, builds your local footprint and makes the search to enquiry process a smoother journey. If you want a <span className="text-[#FFFFFF] font-semibold">Palm Harbor SEO</span> agency that tailors its plan around your business objectives then Geekonomy can develop a bespoke SEO plan for growth.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/palm-harbor.webp"
                                alt="Palm Harbor FL"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Palm Harbor SEARCHES INTO CUSTOMERS
                    </Typography>
