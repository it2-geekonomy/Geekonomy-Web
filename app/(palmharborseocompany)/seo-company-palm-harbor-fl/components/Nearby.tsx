      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="order-1 w-full lg:max-w-2xl">
            ...
            >
              Serving Palm Harbor and Nearby Areas
            </Typography>
            <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
              Local search isn‘t limited to the city itself. Palm Harbor is a small town, and many of its businesspeople are working to attract people in surrounding towns. So, they need an extensive local SEO plan.
            </Typography>
            <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
              Our local SEO strategies can target relevant service areas such as:
            </Typography>
          </div>
          ...
          <div className="order-2 mx-auto w-full max-w-95 lg:mx-0 lg:max-w-130 lg:justify-self-end">
            <div className="aspect-[5/4] w-full overflow-hidden rounded-[1rem] border border-white/10 bg-white/5 shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
              <img
                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/palm-harbor-area.webp"
                alt="Palm Harbor areas"
        ...
        <Typography variant="body-xl" className="mt-7 leading-relaxed text-white/90">
          Concentrating only on the locations that are truly relevant to your business, and creating useful location signals and content without duplicate city name targeting allows you to develop a much more extensive local search presence (and so buy more of the valuable local search clicks), without compromising the usefulness of your site to potential clients.
        </Typography>
