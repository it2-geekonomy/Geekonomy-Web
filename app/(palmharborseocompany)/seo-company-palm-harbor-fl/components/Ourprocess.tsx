      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            A good SEO campaign begins with an insight into your business and ends with it having evolved as a result of constant search improvements. Geekonomy has a predefined process that ensures each phase is laser-focused on tangible potential.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          This method gives our <span className="text-[#FFFFFF] font-semibold">Palm Harbor SEO</span> firm a framework that directs search visibility for your business and sets the stage for evolving your campaign as your business and search landscape do.
        </Typography>
      </div>
    </section>
  );
