      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as a Palm Harbor SEO Company?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Deciding on an SEO provider is deciding on a strategy that can develop in parallel with your business. Geekonomy employs a cost effective, business-oriented mix of local presence, technical SEO, content and authority building rather than any single technique. 
          </Typography>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          Find out how Geekonomy can make your search engine marketing campaign focus solely on achieving long-lasting search results, rather than on the larger concerns of your business.
        </Typography>
      </div>
    </section>
  );
