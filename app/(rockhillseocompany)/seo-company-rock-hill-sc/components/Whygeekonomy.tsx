      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy as an SEO Partner?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Selecting an SEO Consultant is not just finding the person who can get your ranking one spot higher. You need a strategy that grows your business, understands your target markets, and keeps pace with changing searches.  
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          As a Rock Hill SEO company, Geekonomy works towards establishing ongoing search visibility that can be leveraged into your overall marketing and revenue goals, not just achieving short-lived rankings or traffic that do not add value to your business.
        </Typography>
      </div>
    </section>
  );
