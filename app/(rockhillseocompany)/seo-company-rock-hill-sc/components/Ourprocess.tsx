      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Process From Strategy to Growth
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Search Engine Optimization will be successful if all activities are driven by goals. Rather than making jobs that don‘t have an end result we follow a process that links research, optimization, content, authority, monitoring. 
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          Provides for a Rock Hill SEO company strategy that adapts to market developments, comp competitiveness, search habits and company objectives -rather than shifting focus to the latest ranking improvements.
        </Typography>
      </div>
    </section>
  );
