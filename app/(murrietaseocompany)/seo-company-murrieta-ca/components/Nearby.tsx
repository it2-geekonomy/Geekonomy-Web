      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="order-1 w-full lg:max-w-2xl">
            ...
            >
              Local Search Visibility Across Murrieta and Nearby Areas
            </Typography>
            <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
              Your target customers may not be using the word or phrase that is the official city name of your business location. They may be searching from the adjacent cities of your hometown or they may be using something more regional.
            </Typography>
            <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
              We anchor geographic relevance exactly where your business hits the ground, so your website appears for important local search terms without manufacturing weak or duplicate location pages.
            </Typography>
          </div>
          ...
          <div className="order-2 mx-auto w-full max-w-95 lg:mx-0 lg:max-w-130 lg:justify-self-end">
            <div className="aspect-[5/4] w-full overflow-hidden rounded-[1rem] border border-white/10 bg-white/5 shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
              <img
                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Murrieta-area.webp"
                alt="Murrieta areas"
