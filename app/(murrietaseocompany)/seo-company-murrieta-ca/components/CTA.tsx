          ...
          <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-[#69AE44]/25 blur-[6.25rem]" />
            ...
            <div className="relative ">
                <Typography variant="display-2xl" as="p" className="text-white  leading-tight">
                  Ready to Turn Murrieta Searches Into Customers?
                </Typography>

                <Typography variant="body-xl" className="mx-auto mt-5 max-w-4xl leading-relaxed text-white/90">
                  There are people out there looking for the services you offer. The opportunity is to increase your visibility during those searches and to persuade visitors to choose you.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90">
                  Geekonomy integrates technical SEO, local targeting, strategic content, and authority optimization to formulate a search plan that complements your broader business objectives. If your goal is enhanced local prominence, higher quality lead acquisition, or organic growth through your ongoing market communications, we can craft a strategy for you.
                </Typography>
                <Typography variant="body-xl" className="mx-auto mt-4 max-w-4xl leading-relaxed text-white/90 font-semibold">
                  Want to expand your search footprint?
                </Typography>
