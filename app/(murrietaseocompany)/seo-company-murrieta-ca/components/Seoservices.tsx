      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            SEO Services Built for Murrieta Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Each business has unique customers, competitors, and the words people search on. Our SEO solutions are created for the factors that will determine your visibility, but still maintain the campaign solely around an organic sale generated by your quality visitor.
          </Typography>
        </div>
