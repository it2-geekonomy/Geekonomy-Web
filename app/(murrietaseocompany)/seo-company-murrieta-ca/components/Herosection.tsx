                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Murrieta SEO Company{" "}
                            <span className="text-[#69AE44]">That Turns Search Visibility Into Growth</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Your customers are already searching online for the products and services you sell. The question is… how do you make sure they find you and not your competition? As a <span className="text-[#FFFFFF] font-semibold">Murrieta SEO Company</span>, Geekonomy provides search strategies that increase your visibility, attract new visitors, and convert online searchers into customers.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Achieving these results isn‘t just about ranking for a few keywords. We analyze how your customers search, what your competition is doing, how your website is performing and which changes will have the most effect. Whether you‘re looking for greater local visibility, higher quality leads or a better website, we base our actions on measurable business objectives.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          As a top <span className="text-[#FFFFFF] font-semibold">SEO company Murrieta CA</span>, Geekonomy is able to include a balance of technical SEO, local optimization, content, on-page enhancements, and authority building to generate long-term organic growth.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/Murrieta-CA.webp"
                                alt="Murrieta CA"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS Murrieta SEARCHES INTO CUSTOMERS
                    </Typography>
