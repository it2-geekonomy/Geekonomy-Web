                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Gain more awareness, high-quality prospects, and clients with a fully customized digital marketing approach based on your business objectives. We provide a variety of services to aid organizations in Ghaziabad convert online searches into real-world opportunities, ranging from SEO and local search to Google Ads, social media, and conversion-focused websites.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            No matter if you‘re looking to boost your Google rankings, increase paid traffic to generate leads, or enhance your online visibility our digital marketing will help draw the right audience, capture the attention of traffic and convert it into real measurable results.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/heroGhaziabad.png"
                                alt="Digital Marketing Company in Ghaziabad"
