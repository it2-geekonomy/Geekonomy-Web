      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Digital Marketing Services for Madurai Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          Your clients can find your business on Google, Maps, social network, paid ads, or a suggestion online. It is very important for a marketing company to have an overall approach. That’s why an effective strategy must involve various channels instead of treating them individually. Social media management is definitely one.
          </Typography>
          <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
          We offer tailor made digital marketing solutions. digital marketing solutions in Madurai tailored according to your business, customers, competitors and stage of business.
          </Typography>
        </div>
