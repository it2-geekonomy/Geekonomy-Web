                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#69AE44]/30 px-4 py-2 backdrop-blur-sm">
                            ...
                            <Typography variant="overline" className="text-white text-nowrap">
                                Madurai Digital Marketing Agency
                            </Typography>
                        </div>

                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Digital Marketing Company in Madurai{" "}
                            <span className="text-[#69AE44]">That Helps Businesses Grow</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Establish a greater online prominence and convert more searches, visits to your website and interactions on social media into business. Our digital marketing strategy integrates social media management and SEO, deploying analytics-based methods to harness your target group in this digital age. Search Engine Optimization, local Search Engine Optimization, Google AdWords, social media sites promotion, content, conversion optimizationCampaigns centered on your respective objectives having direct Key Performance Indicator are run.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            If you are a local business wanting to bring in more customers in Madurai or an established company looking to grow, we concentrate on those avenues that can send you targeted traffic and trackable leads.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/maduraiherosec.png"
                                alt="Digital Marketing Company in Madurai"
