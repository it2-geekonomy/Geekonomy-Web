...
import { flow, steps } from "../const/Howitworks";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#69AE44]/30 px-4 py-2">
            ...
            How We Generate More Window & Door Leads
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          We have integrated search visibility, pay-to-play campaigns, local promotion and conversion optimization into a simple process to begin turning online demand into ROI.         
          </Typography>
        </div>
