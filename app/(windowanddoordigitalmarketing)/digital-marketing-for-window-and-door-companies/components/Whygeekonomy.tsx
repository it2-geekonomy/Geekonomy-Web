      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy for Window & Door Marketing?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Your marketing must be designed to deliver the right amount of leads and sales rather than meaningless KPIs which boost the figures on the report but do not actually improve the performance of your business.        
          </Typography>
          <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
            Geekonomy integrates industry-specific strategy with SEO, paid advertising, local search, and conversion optimization to develop a window and door customer-centric marketing approach.        
          </Typography>
        </div>
