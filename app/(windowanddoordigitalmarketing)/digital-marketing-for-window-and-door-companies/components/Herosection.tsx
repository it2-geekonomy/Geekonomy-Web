                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            ...
                            <span className="text-[#69AE44]">That Generates More Qualified Leads</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Turn online searches into estimated inquiries, phone calls, and booked appointments with a digital marketing program that was designed for window and door businesses. Geekonomy merges SEO, local search, Google advertising, content,conversion optimization to bring you the homeowners who are searching for replacement windows, new doors, installation, and other associated services.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                            Rather than just basing campaigns on traffic, we develop campaigns around the key terms, locations, services and actions, which, when taken, will lead to the growth of your business. This includes raising your profile in the local search results and turning landing pages into enquiry gatherers.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/herosection-window-and-door.png"
                                alt="Digital Marketing for Window And Door Company"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                        The essential channels, working together for more qualified leads
                    </Typography>
