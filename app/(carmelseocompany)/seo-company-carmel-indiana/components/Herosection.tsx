                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          To get found on the web in Carmel it‘s not just a matter of the name of your location on your site. Your potential customers are looking for exact offerings, filtering through local choices, reading reviews and trying to figure out who they can rely on. Strategies that combine search relevance, local cues and conversions get them toward your site.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          As a <span className="text-[#FFFFFF] font-semibold">Carmel SEO Company</span>, we develop search strategies that are tailored to your business objectives, not simply achieving high rankings. We use a combination of in-depth keyword research, technical seo, local search optimisation, content, authority building and conversion improvement to increase the number of targeted visitors you receive and convert them into enquiries and customers.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          If you require the strongest possible visibility on Google maps, if you wish to optimize your organic rankings or if you are fighting for high intent searches throughout Carmel and the surrounding areas, our approach is centered on creating sustainable search visibility. As a results oriented <span className="text-[#FFFFFF] font-semibold">Carmel SEO</span> company, we pinpoint where your large opportunities are and tailor an SEO plan around the search terms that can really make a difference for your business.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/carmel-indiana.png"
                                alt="Carmel SEO Company"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS CARMEL SEARCHES INTO CUSTOMERS
                    </Typography>
