      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            Why Choose Geekonomy a Digital Marketing Partner Focused on Growth?
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Hiring a digital marketing agency shouldn‘t just be about sourcing a company for SEO, PPC, social or web design. Just as compelling a proposition though, is how all of these activities will complement one another towards definable business goals.       
          </Typography>
          <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
            Geekonomy adopts a strategy-first methodology linking the way you are seen online with the actions that can ultimately generate customers.   
          </Typography>
        </div>
