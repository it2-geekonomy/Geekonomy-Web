                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#69AE44]/30 px-4 py-2 backdrop-blur-sm">
                            ...
                            <Typography variant="overline" className="text-white text-nowrap">
                              Ocean Springs Digital Marketing company
                            </Typography>
                        </div>

                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Digital Marketing Agency in Ocean Springs, MS{" "}
                            <span className="text-[#69AE44]">That Drives Customers</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Right now your customers are already looking for the things you sell. The key is to help them locate your business, believe in your brand, and then do business with you.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          At Geekonomy, a digital marketing agency in Ocean Springs, we work with local companies to strengthen their visibility on Google Search, Google Maps, social media, paid ads and more. We combine the right marketing strategy with conversion-driven website design and quantifiable lead generation, so your online presence helps your business thrive.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/OceanSpringHero.png"
                                alt="Ocean Springs"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN DIGITAL MARKETING ACROSS EVERY CUSTOMER TOUCHPOINT
                    </Typography>
