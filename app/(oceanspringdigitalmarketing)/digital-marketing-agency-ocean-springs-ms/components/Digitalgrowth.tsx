...
import { Items } from "../const/Digitalgrowth";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            A Local-First Digital Marketing Strategy for Ocean Springs
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            It‘s about what your customers are looking for locally and what they need before they even call you in the first place. If you own a business in Ocean Springs, you‘ll want to develop a local search engine marketing plan but keep your overall business focus and revenue in mind.  
          </Typography>
        </div>
