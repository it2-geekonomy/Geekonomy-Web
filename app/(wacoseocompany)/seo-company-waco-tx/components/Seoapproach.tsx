...
import { Items } from "../const/Seoapproach";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <Typography variant="display-2xl" as="h2" className="text-white  leading-tight">
            What Makes Our Waco SEO Approach Different
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
            Seo is not a collection of unconnected techniques; it should be a transparent plan that links search visibility to business objectives.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
          By using this method, Geekonomy can function as a strategic <span className="text-[#FFFFFF] font-semibold">Waco SEO company</span> where each optimization is directly linked to its visibility, relevance, and business building.
          </Typography>
      </div>
    </section>
  );
