    ...
    <section id="results" className="bg-black py-8 lg:py-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          >
           SEO for Different Types of Waco Businesses
          </Typography>
          <Typography variant="body-xl" className="mt-5 leading-relaxed text-white/90">
           The best SEO is achieved when your search engine optimization strategy closely mimics the way your potential customers search for your services or products. We customize everything to your industry, competition, service area and growth projection, never one size fits all.
          </Typography>
        </div>
        ...
        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90">
          No matter what industry you do business in, our <span className="text-[#FFFFFF] font-semibold">Waco SEO Company</span> strategy is designed around the searches that are important to your business, not a cookie-cutter TO-DO List.
        </Typography>
