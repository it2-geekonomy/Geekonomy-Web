                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <Typography variant="display-2xl" as="h1" className="text-white  leading-tight">
                            Waco SEO Company{" "}
                            <span className="text-[#69AE44]">That Helps Businesses Get Found and Grow</span>
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          When search-for-services customers are looking for you on the web, your business must show up right when and where they‘re looking. As a <span className="text-[#FFFFFF] font-semibold">Waco TX</span> SEO company, Geekonomy provides search solutions to maximize your visibility, drive high quality traffic, and convert more searching into leads.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Our strategy integrates local seo, technical seo, content development, and authority Building to put your business against competitors in Waco search results. If you want to increase your visibility on Google Maps, improve organic rankings, or both, we are committed to building you an authentic, sustainable marketing platform.
                        </Typography>
                        <Typography variant="body-xl" className="mt-4 leading-relaxed text-white/90 px-6 lg:px-0 lg:max-w-xl text-left">
                          Searching for a <span className="text-[#FFFFFF] font-semibold">Waco SEO</span> firm that cares about more than just getting traffic? Our SEO approach is centered on enhancing the search results that are significant to your business and the conversions you want to achieve.
                        </Typography>
                    ...
                    <div className="relative">
                        <div className="relative aspect-[3.4/4.4] w-full max-w-[20rem] overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/5 mx-auto sm:max-w-105 lg:max-w-130 lg:mx-0">
                            <img
                                src= "https://pub-67a4c50822e240c78b2f040321a1da26.r2.dev/landing-pages/waco-tx.webp"
                                alt="Waco TX"
            ...
            <div className="relative border-t border-white/30">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 py-10 text-center lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
                    <Typography variant="body-lg" className="rounded-full bg-[#69AE44]/20 px-4 py-2 text-white font-semibold uppercase">
                      DATA-DRIVEN SEO THAT TURNS WACO SEARCHES INTO CUSTOMERS
                    </Typography>
