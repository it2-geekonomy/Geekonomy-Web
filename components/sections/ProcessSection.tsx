...
export default function ProcessSection() {
  ...
  const totalPhases = PROCESS_PHASES.length;
    ...
    <section ref={sectionRef} className="relative w-full bg-black pb-18">
      <div className="w-full px-4 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 mx-4 sm:mx-6 lg:mx-14 xl:mx-[clamp(0.5rem,0.5rem+10vw,10rem)] 2xl:mx-[clamp(1rem,1rem+15vw,22rem)] items-start">
          ...
          <div
            className="lg:col-span-3 flex gap-6 lg:gap-12 items-stretch h-[280px] relative"
            style={{
          ...
          >
            ...
            <div className="flex-1 overflow-hidden relative">
              <div
                style={{
                  transform: `translateY(-${currentPhase * 280}px)`,
              ...
              >
                {PROCESS_PHASES.map((phase, index) => {
                  ...
                  return (
                    <div
                      key={phase.number}
                      className="flex flex-col justify-center h-[280px]"
                      style={{
                    ...
                    >
                      ...
                      <Typography as="h3" variant="body-xl" className="text-[#69AE44] mb-4 font-normal">
                        {phase.name}
                      </Typography>
                      <div className="flex items-center gap-2 mb-2">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                          <circle cx="8" cy="8" r="7" stroke="#69AE44" strokeWidth="1.5" />
                          <path d="M5 8l2 2 4-4" stroke="#69AE44" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <Typography as="span" variant="body-xl" className="text-white text-xs uppercase tracking-widest">
                          KEY QUESTION
                        </Typography>
                      </div>
                      <Typography as="p" variant="body-xl" className="text-white leading-relaxed max-w-lg">
                        {phase.keyQuestion}
                      </Typography>
                    </div>
                  );
