    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="inline-block cursor-pointer rounded-full border-2 border-[#69AE44] bg-transparent px-10 py-3 text-sm font-semibold uppercase tracking-wide text-[#69AE44] transition-all duration-200 hover:bg-[#69AE44] hover:text-black sm:px-12 sm:py-3.5 sm:text-base"
        >
